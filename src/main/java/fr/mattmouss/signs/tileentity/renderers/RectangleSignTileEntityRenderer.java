...
@OnlyIn(Dist.CLIENT)
public class RectangleSignTileEntityRenderer extends TileEntityRenderer<RectangleSignTileEntity> {
    ...
    private final SpecialSignModel model = new SpecialSignModel(Form.RECTANGLE);

    public RectangleSignTileEntityRenderer() {
    }

    @Override
    public void render(RectangleSignTileEntity tileEntityIn, double x, double y, double z, float partialTicks, int destroyStage) {
