...
@OnlyIn(Dist.CLIENT)
public class UpsideTriangleSignTileEntityRenderer extends TileEntityRenderer<UpsideTriangleSignTileEntity> {
    ...
    private final SpecialSignModel model = new SpecialSignModel(Form.UPSIDE_TRIANGLE);

    public UpsideTriangleSignTileEntityRenderer() {
    }

    @Override
    public void render(UpsideTriangleSignTileEntity tileEntityIn, double x, double y, double z, float partialTicks, int destroyStage) {
