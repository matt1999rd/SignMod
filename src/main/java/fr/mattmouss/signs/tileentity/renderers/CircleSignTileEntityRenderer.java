...
@OnlyIn(Dist.CLIENT)
public class CircleSignTileEntityRenderer extends TileEntityRenderer<CircleSignTileEntity> {
    ...
    private final SpecialSignModel model = new SpecialSignModel(Form.CIRCLE);

    public CircleSignTileEntityRenderer() {
    }

    @Override
    public void render(CircleSignTileEntity tileEntityIn, double x, double y, double z, float partialTicks, int destroyStage) {
